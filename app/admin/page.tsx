...
const SECTIONS = {
  ...
  'set-builder':   { label: 'Set Builder',      icon: Layers,          group: 'Music'       },
  ...
  'road-to-san-antonio': { label: 'Road to San Antonio', icon: Flag,   group: 'Outreach'    },
...
const SectionComponents: Record<TabKey, React.ComponentType> = {
  ...
  'set-builder':     dynamic(() => import('./sections/AdminSetBuilder')),
  ...
  'road-to-san-antonio': dynamic(() => import('./sections/AdminRoadToSanAntonio')),
