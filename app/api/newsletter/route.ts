    ...
    <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;max-width:600px;width:100%;">
      ...
      <tr><td style="background:#030202;padding:36px 40px 32px;text-align:center;">
        ...
        <div style="display:inline-block;background:#c9a84c;padding:20px 40px;margin:0 0 28px;">
          <p style="margin:0 0 4px;font-size:10px;letter-spacing:3px;text-transform:uppercase;color:#030202;font-weight:700;">Your code / Tu código</p>
      ...
      <tr><td style="padding:36px 40px;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
          <tr><td style="padding:8px 12px 8px 0;font-size:14px;color:#444444;border-bottom:1px solid #f0ede8;">☕ Support Mug</td><td style="padding:8px 0;font-size:14px;color:#c9a84c;text-align:right;border-bottom:1px solid #f0ede8;">From $8.95</td></tr>
          <tr><td style="padding:8px 12px 8px 0;font-size:14px;color:#444444;border-bottom:1px solid #f0ede8;">🧢 Warrior Hat</td><td style="padding:8px 0;font-size:14px;color:#c9a84c;text-align:right;border-bottom:1px solid #f0ede8;">$19.99</td></tr>
          <tr><td style="padding:8px 12px 8px 0;font-size:14px;color:#444444;border-bottom:1px solid #f0ede8;">🧢 Trucker Hat</td><td style="padding:8px 0;font-size:14px;color:#c9a84c;text-align:right;border-bottom:1px solid #f0ede8;">$19.99</td></tr>
          <tr><td style="padding:8px 12px 8px 0;font-size:14px;color:#444444;">👕 Premium Tee</td><td style="padding:8px 0;font-size:14px;color:#c9a84c;text-align:right;">From $34.99</td></tr>
        </table>
        ...
        <p style="margin:28px 0 0;font-size:14px;color:#444444;line-height:1.75;">
          God bless,<br><strong>Malachias</strong><br>
          <span style="color:#888888;font-style:italic;">Que Dios los bendiga</span>
        </p>
      </td></tr>
      ...
      <tr><td style="background:#f9f7f4;padding:20px 40px;border-top:1px solid #e8e0d5;">
        <p style="margin:0 0 8px;font-size:11px;color:#999999;line-height:1.5;">
          Malachias · South Florida · USA · <a href="mailto:hello@malachiasmusic.com" style="color:#999999;">hello@malachiasmusic.com</a>
        </p>
        <p style="margin:0;font-size:11px;color:#999999;">
          You subscribed at <a href="${SITE_URL}" style="color:#999999;">malachiasmusic.com</a>.
          &nbsp;·&nbsp;
          <a href="${unsubUrl}" style="color:#c9a84c;">Unsubscribe / Cancelar suscripción</a>
        </p>
      </td></tr>
