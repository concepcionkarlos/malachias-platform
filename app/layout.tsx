...
export const metadata: Metadata = {
  ...
  description:
    'Malachias is a Christian rock band founded by a U.S. Army veteran from Fort Wayne, Indiana. Bars, festivals, churches, military events — we play wherever the music is needed.',
  keywords: [
    'Christian rock band', 'veteran music', 'faith rock', 'military band', 'Malachias',
    'Fort Wayne Indiana band', 'rock festival', 'Christian metal', 'veteran musician',
    'book a band Indiana', 'rock band for hire',
  ],
...
const jsonLd = {
  ...
  '@type': 'MusicGroup',
  name: 'Malachias',
  description: 'Christian rock band founded by a U.S. Army veteran. Music for bars, festivals, churches, and community events. Fort Wayne, Indiana.',
